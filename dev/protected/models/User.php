 ...
 * @property integer $id                    主键用户ID
 * @property integer $public_id             所属公众号的id
 * @property integer $source                客户来源
 * @property string $openid                 客户唯一ID,openID
 * @property string $nickname               用户名
 * @property integer $star                  是否是星标客户
 * @property integer $level                 用户等级
 * @property integer $group_id              分组ID
 * @property string $remark                 备注名
 * @property string $subscribe              是否关注
 * @property string $headimgurl             头像
 * @property string $mobile                 手机号码
 * @property integer $sex                   性别:0:未知 1:男  2:女
 * @property integer $age                   年龄
 * @property string $language               语言
 * @property integer $country               所在国家
 * @property integer $province              所在省份
 * @property integer $city                  所在城市
 * @property integer $district              所在区县
 * @property integer $subscribe_time        关注时间
 * @property string $unionid                UnionID机制,unionid
 * @property integer $integral              积分
 * @property integer $time_message_last     上次对话时间
 * @property integer $status                数据状态
