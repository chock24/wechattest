    ...
    <div class="margin-top-10 tabhost">
        <div class="tabhost-title">
            <ul>
                ...
                <li class="active"><a href="<?php echo Yii::app()->createUrl('systems/giftExchange/index'); ?>">礼品兑换记录</a></li>
            </ul>
            <div class="clear"></div>
        </div>
    ...
    $(function () {
        $('.wechat-table').find('input,select').change(function () {
            if ($(this).attr('data-id') != 'data-checkbox') {
                var url = "<?php echo Yii::app()->createUrl('systems/giftExchange/ajaxupdate'); ?>";
