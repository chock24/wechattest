...
<div class="right content-main">
    <!--<h2 class="content-main-title">欢迎语</h2>-->
    <div>
        <div class="margin-top-10 tabhost">
            <div class="tabhost-title">
                <ul>
                    <li class="active"><a href="<?php echo Yii::app()->createUrl('/basis/welcome/index'); ?>">欢迎语</a></li>
            ...
            <div class="tabhost-center">
                ...
                <?php endif; ?>
                <!--文字预览-->
                <div class="margin-top-15 none text-preview">
                    ...
                    <div class="margin-top-15 editing">
                        <div class="editing-tab">
                            <ul class="editing-tab-nav">
                                ...
                                <li>
                                <?php echo CHtml::link('<i class="icon icon-img"></i>', array('sourcefile', 'type' => 2), array('title' => '图片', 'onclick' => 'js:return popup($(this),"图片",850,500);')); ?>
                                </li>
                                <li>
                                ...
                                <li>
                                <?php echo CHtml::link('<i class="icon icon-voice"></i>', array('sourcefile', 'type' => 3), array('title' => '音频', 'onclick' => 'js:return popup($(this),"音频",850,500);')); ?>
                                </li>
                                <li>
                                <?php echo CHtml::link('<i class="icon icon-video"></i>', array('sourcefile', 'type' => 4), array('title' => '视频', 'onclick' => 'js:return popup($(this),"视频",850,500);')); ?>
                                </li>
                            </ul>
