    ...
    <div class="message img_txt_message">
        ...
        <div class="content img_txt_col width81">
            <div class="img_txt_sc">
                ...
                <a href="<?php echo Yii::app()->createUrl("/basis/sourcefile/onlymsg") ?>" class="da_img"><i class="img_txt_icon"></i><strong>单图文消息</strong></a>
                <a href="<?php echo Yii::app()->createUrl("/basis/sourcefile/moremsg") ?>" class="du_img"><i class="img_txt_icon"></i><strong>多图文消息</strong></a>
            </div>
        ...
        <div class="sidebar">
            <dl>
                <dd>
                    <?php echo CHtml::link('显示全部', array('/basis/sourcefile/appmsgmore')); ?>
                </dd>
                <?php
                ...
                ?>
                <dd>
                    <?php echo CHtml::link('+添加分组', array('/basis/sourcefilegather/create/', 'type' => 5,'multi'=>'1'), array('class' => 'create-gather-item')); ?>
                </dd>
            </dl>
        </div>
    </div>
...
<script type="text/javascript">
    $(function () {
        ...
        //右边鼠标经过显示菜单的
        $('.img_right dl').find('dd').hover(function () {
