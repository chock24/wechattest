...
<!-- <div class="popup-fodder popup-fodder-mage-img" data-id="<?php //echo CHtml::encode($data->filename.".".$data->ext); ?>" data-multi="0" data-type="2" onclick="return popupSelect($(this),$('#select-result'));">-->
 <div class="popup-fodder popup-fodder-mage-video" data-id="<?php echo CHtml::encode($data->id); ?>" data-multi="0" data-type="4" onclick="return popupSelect($(this),$('#select-result'));">
    <div class="popup-fodder-center popup-fodder-mage-video-center">
        <div class="color-9 popup-fodder-introduce"><?php echo PublicStaticMethod::truncate_utf8_string($data->title,10); ?></div>
        <div class="popup-fodder-img popup-fodder-mage-video-img">
            <video class="none" src="<?php echo PublicStaticMethod::returnFile('sourcefile', $data->filename, $data->ext, 'image', 'medium'); ?>" controls="controls">您的浏览器不支持 video 标签。</video>
            <?php /*echo CHtml::image(PublicStaticMethod::returnFile('sourcefile', $data->filename, $data->ext, 'image', 'medium')) */?>
        </div>
    </div>
    <div class="none popup-selected">
