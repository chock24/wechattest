(function() {
    ...
    var utils = UE.utils = {makeInstance: function(obj) {
    ...
    var domUtils = dom.domUtils = {NODE_ELEMENT: 1, NODE_DOCUMENT: 9, NODE_TEXT: 3, NODE_COMMENT: 8, NODE_DOCUMENT_FRAGMENT: 11, POSITION_IDENTICAL: 0, POSITION_DISCONNECTED: 1, POSITION_FOLLOWING: 2, POSITION_PRECEDING: 4, POSITION_IS_CONTAINED: 8, POSITION_CONTAINS: 16, fillChar: ie && browser.version == "6" ? "\ufeff" : "\u200B", keys: {8: 1, 46: 1, 16: 1, 17: 1, 18: 1, 37: 1, 38: 1, 39: 1, 40: 1, 13: 1}, getPosition: function(nodeA, nodeB) {
        ...
        }, unselectable: gecko ? function(node) {
            node.style.MozUserSelect = "none";
        } : webkit ? function(node) {
    ...
    (function() {
        ...
        function setValue(form, editor) {
            ...
            if (!textarea) {
                form.appendChild(textarea = domUtils.creElm(document, "textarea", {"name": editor.options.textarea, "id": "ueditor_textarea_" + editor.options.textarea, "style": "display:none"}));
            }
        ...
        Editor.prototype = {setOpt: function(key, val) {
                ...
                var reg = new RegExp(domUtils.fillChar, "g"), html = this.body.innerHTML.replace(reg, "").replace(/>[\t\r\n]*?</g, "><");
    ...
    UE.plugins["autotypeset"] = function() {
        ...
        var me = this, opt = me.options.autotypeset, remainClass = {"selectTdClass": 1, "pagebreak": 1, "anchorclass": 1}, remainTag = {"li": 1}, tags = {div: 1, p: 1, blockquote: 1, center: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, highlightCont;
        if (!opt) {
            return;
        }
    ...
    UE.commands["autosubmit"] = {execCommand: function() {
    ...
    UE.commands["insertimage"] = {execCommand: function(cmd, opt) {
            ...
            if (img && /img/i.test(img.tagName) && img.className != "edui-faked-video" && !img.getAttribute("word_img")) {
                ...
                var html = [], str = "", ci;
                ci = opt[0];
                // 2015-01-29田科修改 data_ue_src 路径为src
                if (opt.length == 1) { 
                    str = '<img src="' + ci.src + '" ' + (ci.data_ue_src ? ' data_ue_src="' + ci.src + '" ' : "") + (ci.width ? 'width="' + ci.width + '" ' : "") + (ci.height ? ' height="' + ci.height + '" ' : "") + (ci["floatStyle"] && ci["floatStyle"] != "center" ? ' style="float:' + ci["floatStyle"] + ';"' : "") + (ci.title ? ' title="' + ci.title + '"' : "") + ' border="' + (ci.border || 0) + '" hspace = "' + (ci.hspace || 0) + '" vspace = "' + (ci.vspace || 0) + '" />';
                    ...
                    for (var i = 0; ci = opt[i++]; ) {
                        str = "<p " + (ci["floatStyle"] == "center" ? 'style="text-align: center" ' : "") + '><img src="' + ci.src + '" ' + (ci.width ? 'width="' + ci.width + '" ' : "") + (ci.data_ue_src ? ' data_ue_src="' + ci.src + '" ' : "") + (ci.height ? ' height="' + ci.height + '" ' : "") + ' style="' + (ci["floatStyle"] && ci["floatStyle"] != "center" ? "float:" + ci["floatStyle"] + ";" : "") + (ci.border || "") + '" ' + (ci.title ? ' title="' + ci.title + '"' : "") + " /></p>";
                        html.push(str);
                    }
                }
    ...
    (function() {
        var block = domUtils.isBlockElm, defaultValue = {left: 1, right: 1, center: 1, justify: 1}, doJustify = function(range, style) {
    ...
    UE.plugins["font"] = function() {
        var me = this, fonts = {"forecolor": "color", "backcolor": "background-color", "fontsize": "font-size", "fontfamily": "font-family", "underline": "text-decoration", "strikethrough": "text-decoration"};
        me.setOpt({"fontfamily": [["宋体", ["宋体", "SimSun"]], ["楷体", ["楷体", "楷体_GB2312", "SimKai"]], ["黑体", ["黑体", "SimHei"]], ["隶书", ["隶书", "SimLi"]], ["andale mono", ["andale mono"]], ["arial", ["arial", "helvetica", "sans-serif"]], ["arial black", ["arial black", "avant garde"]], ["comic sans ms", ["comic sans ms"]], ["impact", ["impact", "chicago"]], ["times new roman", ["times new roman"]]], "fontsize": [10, 11, 12, 14, 16, 18, 20, 24, 36]});
        for (var p in fonts) {
            (function(cmd, style) {
    ...
    (function() {
        ...
        UE.commands["link"] = {queryCommandState: function() {
                return this.highlight ? -1 : 0;
    ...
    UE.commands["gmap"] = UE.commands["map"] = {queryCommandState: function() {
            return this.highlight ? -1 : 0;
        }};
    UE.plugins["insertframe"] = function() {
        ...
        me.commands["insertframe"] = {queryCommandState: function() {
                return this.highlight ? -1 : 0;
            }};
    };
    ...
    (function() {
        ...
        UE.commands["blockquote"] = {execCommand: function(cmdName, attrs) {
    ...
    UE.commands["anchor"] = {execCommand: function(cmd, name) {
    ...
    UE.commands["delete"] = {execCommand: function() {
    ...
    UE.plugins["wordcount"] = function() {
        var me = this;
        me.setOpt({wordCount: true, maximumWords: 10000, wordCountMsg: "当前已输入 {#count} 个字符，您还可以输入{#leave} 个字符 ", wordOverFlowMsg: '<span style="color:red;">你输入的字符个数已经超出最大允许值，服务器可能会拒绝保存！</span>'});
        var opt = me.options, max = opt.maximumWords, msg = opt.wordCountMsg, errMsg = opt.wordOverFlowMsg;
        if (!opt.wordCount) {
            return;
        }
        me.commands["wordcount"] = {queryCommandValue: function(cmd, onlyCount) {
                ...
                if (div.firstChild) {
                    ...
                    if (f) {
                        try {
                            ...
                            node = f.filter(node, pasteplain ? {whiteList: {"p": {"br": 1, "BR": 1}, "br": {"$": {}}, "div": {"br": 1, "BR": 1, "$": {}}, "li": {"$": {}}, "tr": {"td": 1, "$": {}}, "td": {"$": {}}}, blackList: {"style": 1, "script": 1, "object": 1}} : null, !pasteplain ? modify_num : null);
                            if (browser.webkit) {
    ...
    UE.plugins["list"] = function() {
        ...
        me.setOpt({"insertorderedlist": [["1,2,3...", "decimal"], ["a,b,c...", "lower-alpha"], ["i,ii,iii...", "lower-roman"], ["A,B,C", "upper-alpha"], ["I,II,III...", "upper-roman"]], "insertunorderedlist": [["○ 小圆圈", "circle"], ["● 小圆点", "disc"], ["■ 小方块", "square"]]});
    ...
    (function() {
        ...
        UE.plugins["source"] = function() {
            ...
            if (opt.sourceEditor == "codemirror") {
                me.addListener("ready", function() {
                    utils.loadFile(document, {src: opt.codeMirrorJsUrl || opt.UEDITOR_HOME_URL + "third-party/codemirror2.15/codemirror.js", tag: "script", type: "text/javascript", defer: "defer"});
                    utils.loadFile(document, {tag: "link", rel: "stylesheet", type: "text/css", href: opt.codeMirrorCssUrl || opt.UEDITOR_HOME_URL + "third-party/codemirror2.15/codemirror.css"});
                });
            }
        };
    })();
    UE.plugins["shortcutkeys"] = function() {
        var me = this, shortcutkeys = {"ctrl+66": "Bold", "ctrl+90": "Undo", "ctrl+89": "Redo", "ctrl+73": "Italic", "ctrl+85": "Underline", "ctrl+shift+67": "removeformat", "ctrl+shift+76": "justify:left", "ctrl+shift+82": "justify:right", "ctrl+65": "selectAll", "ctrl+13": "autosubmit"};
    ...
    UE.plugins["keystrokes"] = function() {
        var me = this, flag = 0, keys = domUtils.keys, trans = {"B": "strong", "I": "em", "FONT": "span"}, sizeMap = [0, 10, 12, 16, 18, 24, 32, 48], listStyle = {"OL": ["decimal", "lower-alpha", "lower-roman", "upper-alpha", "upper-roman"], "UL": ["circle", "disc", "square"]};
        me.addListener("keydown", function(type, evt) {
            var keyCode = evt.keyCode || evt.which;
            if (this.selectAll) {
    ...
    UE.plugins["autofloat"] = function() {
        var me = this, optsAutoFloatEnabled = me.options.autoFloatEnabled !== false;
        ...
        function checkHasUI(editor) {
            if (!editor.ui) {
                ...
                throw ({name: "未包含UI文件", message: "autofloat功能依赖于UEditor UI。autofloat定义位置: _src/plugins/autofloat.js"});
            }
            return 1;
        }
        ...
        function setFloating() {
            ...
            if (LteIE6 || quirks) {
                ...
                if (toolbarBox.style.position != "fixed") {
                    ...
                    toolbarBox.style.top = "0";//修改菜单栏距离顶部的距离
    ...
    UE.plugins["highlight"] = function() {
        ...
        me.addListener("ready", function() {
            if (typeof XRegExp == "undefined") {
                var obj = {id: "syntaxhighlighter_js", src: me.options.highlightJsUrl || me.options.UEDITOR_HOME_URL + "third-party/SyntaxHighlighter/shCore.js", tag: "script", type: "text/javascript", defer: "defer"};
                utils.loadFile(document, obj, function() {
                    changePre();
                });
            }
            if (!me.document.getElementById("syntaxhighlighter_css")) {
                var obj = {id: "syntaxhighlighter_css", tag: "link", rel: "stylesheet", type: "text/css", href: me.options.highlightCssUrl || me.options.UEDITOR_HOME_URL + "third-party/SyntaxHighlighter/shCoreDefault.css"};
            ...
            switch (node.tag) {
                ...
                case"li":
                    ...
                    if (!child || child.type != "element" || child.tag != "p" && dtd.p[child.tag]) {
                        ...
                        tmpPNode.children = child ? node.children : [browser.ie ? {type: "text", data: domUtils.fillChar, parent: tmpPNode} : {type: "element", tag: "br", attributes: {}, closed: true, children: [], parent: tmpPNode}];
    ...
    UE.plugins["table"] = function() {
        ...
        me.commands["edittd"] = {queryCommandState: function() {
                if (this.highlight) {
                    return -1;
                }
                var range = this.selection.getRange();
                ...
                for (var i = 0, td; td = tds[i++]; ) {
                    domUtils.setAttributes(td, {"bgColor": tdItems.bgColor, "align": tdItems.align, "vAlign": tdItems.vAlign});
                }
            }};
    ...
    UE.plugins["contextmenu"] = function() {
        var me = this, menu, items = me.options.contextMenu || [{label: "删除", cmdName: "delete"}, {label: "全选", cmdName: "selectall"}, {label: "删除代码", cmdName: "highlightcode", icon: "deletehighlightcode"}, {label: "清空文档", cmdName: "cleardoc", exec: function() {
                    if (confirm("确定清空文档吗？")) {
                        this.execCommand("cleardoc");
                    }
                }}, "-", {label: "取消链接", cmdName: "unlink"}, "-", {group: "段落格式", icon: "justifyjustify", subMenu: [{label: "居左对齐", cmdName: "justify", value: "left"}, {label: "居右对齐", cmdName: "justify", value: "right"}, {label: "居中对齐", cmdName: "justify", value: "center"}, {label: "两端对齐", cmdName: "justify", value: "justify"}]}, "-", {label: "表格属性", cmdName: "edittable", exec: function() {
                    this.ui._dialogs["inserttableDialog"].open();
                }}, {label: "单元格属性", cmdName: "edittd", exec: function() {
                    if (UE.ui["edittd"]) {
                        new UE.ui["edittd"](this);
                    }
                    this.ui._dialogs["edittdDialog"].open();
                }}, {group: "表格", icon: "table", subMenu: [{label: "删除表格", cmdName: "deletetable"}, {label: "表格前插行", cmdName: "insertparagraphbeforetable"}, "-", {label: "删除行", cmdName: "deleterow"}, {label: "删除列", cmdName: "deletecol"}, "-", {label: "前插入行", cmdName: "insertrow"}, {label: "前插入列", cmdName: "insertcol"}, "-", {label: "右合并单元格", cmdName: "mergeright"}, {label: "下合并单元格", cmdName: "mergedown"}, "-", {label: "拆分成行", cmdName: "splittorows"}, {label: "拆分成列", cmdName: "splittocols"}, {label: "合并多个单元格", cmdName: "mergecells"}, {label: "完全拆分单元格", cmdName: "splittocells"}]}, {label: "复制(ctrl+c)", cmdName: "copy", exec: function() {
                    alert("请使用ctrl+c进行复制");
                }, query: function() {
                    return 0;
                }}, {label: "粘贴(ctrl+v)", cmdName: "paste", exec: function() {
                    alert("请使用ctrl+v进行粘贴");
                }, query: function() {
                    return 0;
                }}];
                ...
                (function(item) {
                    if (item == "-") {
                        ...
                        if (item.group) {
                                ...
                                (function(subItem) {
                                    if (subItem == "-") {
                                        ...
                                        if ((me.commands[subItem.cmdName] || UE.commands[subItem.cmdName] || subItem.query) && (subItem.query ? subItem.query() : me.queryCommandState(subItem.cmdName)) > -1) {
                                            subMenu.push({"label": subItem.label, className: "edui-for-" + subItem.cmdName + (subItem.value || ""), onclick: subItem.exec ? function() {
                            ...
                            if (subMenu.length) {
                                contextItems.push({"label": item.group, className: "edui-for-" + item.icon, "subMenu": {items: subMenu, editor: me}});
                            }
                        } else {
                            if ((me.commands[item.cmdName] || UE.commands[item.cmdName] || item.query) && (item.query ? item.query() : me.queryCommandState(item.cmdName)) > -1) {
                                ...
                                contextItems.push({"label": item.label, className: "edui-for-" + (item.icon ? item.icon : item.cmdName + (item.value || "")), onclick: item.exec ? function() {
                                        item.exec.call(me);
                                    } : function() {
    ...
    UE.plugins["catchremoteimage"] = function() {
        ...
        var me = this;
        this.setOpt({localDomain: ["127.0.0.1", "localhost"], separater: "ue_separate_ue", catchFieldName: "upfile", catchRemoteImageEnable: true});
    ...
    UE.commands["snapscreen"] = {execCommand: function() {
            var me = this;
            ...
            var onSuccess = function(rs) {
                ...
                me.execCommand("insertimage", {src: editorOptions.snapscreenPath + rs.url, floatStyle: editorOptions.snapscreenImgAlign, data_ue_src: editorOptions.snapscreenPath + rs.url});
            };
    ...
    UE.commands["attachment"] = {queryCommandState: function() {
            return this.highlight ? -1 : 0;
        }};
    UE.plugins["webapp"] = function() {
        ...
        UE.commands["webapp"] = {execCommand: function(cmd, obj) {
    ...
    (function() {
        ...
        ColorPicker.prototype = {getHtmlTpl: function() {
                return genColorPicker(this.noColorText);
    ...
    (function() {
        ...
        baidu.editor.ui.Stateful = {alwalysHoverable: false, Stateful_init: function() {
    ...
    (function() {
        ...
        ColorButton.prototype = {initColorButton: function() {
                var me = this;
                this.popup = new Popup({content: new ColorPicker({noColorText: "清除颜色", onpickcolor: function(t, color) {
    ...
    (function() {
        ...
        TableButton.prototype = {initTableButton: function() {
                var me = this;
                this.popup = new Popup({content: new TablePicker({onpicktable: function(t, numCols, numRows) {
    ...
    (function() {
        ...
        Dialog.prototype = {draggable: false, uiName: "dialog", initDialog: function() {
                ...
                this.closeButton = new Button({className: "edui-dialog-closebutton", title: "关闭对话框", onclick: function() {
                        me.close(false);
                    }});
                if (this.buttons) {
    ...
    (function() {
        ...
        for (var i = 0, ci; ci = btnCmds[i++]; ) {
            ...
            editorui[ci] = function(cmd) {
                return function(editor, title) {
                    var ui = new editorui.Button({className: "edui-for-" + cmd, title: title || editor.options.labelMap[cmd] || "", onclick: function() {
        ...
        editorui.cleardoc = function(editor, title) {
            var ui = new editorui.Button({className: "edui-for-cleardoc", title: title || editor.options.labelMap.cleardoc || "", onclick: function() {
                    if (confirm("确定清空文档吗？")) {
                ...
                for (var i = 0, ci; ci = val[i++]; ) {
                    (function(cmd2) {
                        editorui[cmd.replace("float", "") + cmd2] = function(editor, title) {
                            var ui = new editorui.Button({className: "edui-for-" + cmd.replace("float", "") + cmd2, title: title || editor.options.labelMap[cmd.replace("float", "") + cmd2] || "", onclick: function() {
        ...
        for (var i = 0, ci; ci = ["backcolor", "forecolor"][i++]; ) {
            editorui[ci] = function(cmd) {
                return function(editor, title) {
                    var ui = new editorui.ColorButton({className: "edui-for-" + cmd, color: "default", title: title || editor.options.labelMap[cmd] || "", editor: editor, onpickcolor: function(t, color) {
        ...
        var dialogBtns = {noOk: ["searchreplace", "help", "spechars", "webapp"], ok: ["attachment", "anchor", "link", "insertimage", "map", "gmap", "insertframe", "wordimage", "insertvideo", "highlightcode", "insertframe", "edittd"]};
                ...
                for (var i = 0, ci; ci = vals[i++]; ) {
                    (function(cmd) {
                        editorui[cmd] = function(editor, iframeUrl, title) {
                            ...
                            var dialog;
                            if (iframeUrl) {
                                dialog = new editorui.Dialog(utils.extend({iframeUrl: editor.ui.mapUrl(iframeUrl), editor: editor, className: "edui-for-" + cmd, title: title}, type == "ok" ? {buttons: [{className: "edui-okbutton", label: "确认", onclick: function() {
                                                dialog.close(true);
        ...
        editorui.snapscreen = function(editor, iframeUrl, title) {
            ...
            if (browser.ie) {
                ...
                if (iframeUrl) {
                    var dialog = new editorui.Dialog({iframeUrl: editor.ui.mapUrl(iframeUrl), editor: editor, className: "edui-for-snapscreen", title: title, buttons: [{className: "edui-okbutton", label: "确认", onclick: function() {
                                    dialog.close(true);
                                }}, {className: "edui-cancelbutton", label: "取消", onclick: function() {
                                    dialog.close(false);
                                }}]});
        ...
        editorui.fontfamily = function(editor, list, title) {
            ...
            for (var i = 0, ci, items = []; ci = list[i++]; ) {
                (function(key, val) {
                    items.push({label: key, value: val, renderLabelHtml: function() {
                            return'<div class="edui-label %%-label" style="font-family:' + utils.unhtml(this.value.join(",")) + '">' + (this.label || "") + "</div>";
                        }});
                })(ci[0], ci[1]);
            }
        ...
        editorui.fontsize = function(editor, list, title) {
            ...
            for (var i = 0; i < list.length; i++) {
                var size = list[i] + "px";
                items.push({label: size, value: size, renderLabelHtml: function() {
        ...
        editorui.paragraph = function(editor, list, title) {
            ...
            for (var i = 0, items = []; i < list.length; i++) {
                ...
                var tag = item[0];
                var label = item[1];
                items.push({label: label, value: tag, renderLabelHtml: function() {
        ...
        editorui.customstyle = function(editor, list, title) {
            ...
            for (var i = 0, items = [], t; t = list[i++]; ) {
                (function(ti) {
                    items.push({label: ti.label, value: ti, renderLabelHtml: function() {
                            return'<div class="edui-label %%-label">' + "<" + ti.tag + " " + (ti.className ? ' class="' + ti.className + '"' : "") + (ti.style ? ' style="' + ti.style + '"' : "") + ">" + ti.label + "</" + ti.tag + ">" + "</div>";
                        }});
                })(t);
            }
        ...
        editorui.inserttable = function(editor, iframeUrl, title) {
            ...
            if (iframeUrl) {
                var dialog = new editorui.Dialog({iframeUrl: editor.ui.mapUrl(iframeUrl), editor: editor, className: "edui-for-inserttable", title: title, buttons: [{className: "edui-okbutton", label: "确认", onclick: function() {
                                dialog.close(true);
                            }}, {className: "edui-cancelbutton", label: "取消", onclick: function() {
                                dialog.close(false);
                            }}]});
        ...
        editorui.lineheight = function(editor, title) {
            ...
            for (var i = 0, ci, items = []; ci = val[i++]; ) {
                items.push({label: ci == "1" ? "默认" : ci, value: ci, onclick: function() {
                        editor.execCommand("lineheight", this.value);
                    }});
            }
            var ui = new editorui.MenuButton({editor: editor, className: "edui-for-lineheight", title: title || editor.options.labelMap["lineheight"] || "", items: items, onbuttonclick: function() {
        ...
        for (var r = 0, ri; ri = rowspacings[r++]; ) {
            (function(cmd) {
                editorui["rowspacing" + cmd] = function(editor) {
                    ...
                    for (var i = 0, ci, items = []; ci = val[i++]; ) {
                        items.push({label: ci, value: ci, onclick: function() {
                                editor.execCommand("rowspacing", this.value, cmd);
                            }});
                    }
                    var ui = new editorui.MenuButton({editor: editor, className: "edui-for-rowspacing" + cmd, title: editor.options.labelMap["rowspacing" + cmd], items: items, onbuttonclick: function() {
            ...
            (function(cmd) {
                editorui[cmd] = function(editor) {
                    ...
                    for (var i = 0, items = [], ci; ci = vals[i++]; ) {
                        items.push({label: ci[0], value: ci[1], onclick: _onMenuClick});
                    }
                    var ui = new editorui.MenuButton({editor: editor, className: "edui-for-" + cmd, title: editor.options.labelMap[cmd] || "", "items": items, onbuttonclick: function() {
        ...
        editorui.fullscreen = function(editor, title) {
            ...
            var ui = new editorui.Button({className: "edui-for-fullscreen", title: title, onclick: function() {
                    if (editor.ui) {
        ...
        editorui.emotion = function(editor, iframeUrl, title) {
            var ui = new editorui.MultiMenuPop({title: title || editor.options.labelMap.emotion || "", editor: editor, className: "edui-for-emotion", iframeUrl: editor.ui.mapUrl(iframeUrl || (editor.options.iframeUrlMap || {})["emotion"] || iframeUrlMap["emotion"])});
            editor.addListener("selectionchange", function() {
        ...
        editorui.autotypeset = function(editor) {
            var ui = new editorui.AutoTypeSetButton({editor: editor, title: editor.options.labelMap["autotypeset"] || "", className: "edui-for-autotypeset", onbuttonclick: function() {
                ...
                if (editor.options.imagePopup) {
                    editor.addListener("mouseover", function(t, evt) {
                        ...
                        if (editor.ui._dialogs.insertframeDialog && /iframe/ig.test(el.tagName)) {
                            var html = popup.formatHtml('<nobr>属性: <span onclick=$$._setIframeAlign(-2) class="edui-clickable">默认</span>&nbsp;&nbsp;<span onclick=$$._setIframeAlign(-1) class="edui-clickable">左对齐</span>&nbsp;&nbsp;<span onclick=$$._setIframeAlign(1) class="edui-clickable">右对齐</span>&nbsp;&nbsp;' + '<span onclick=$$._setIframeAlign(2) class="edui-clickable">居中</span>' + ' <span onclick="$$._updateIframe( this);" class="edui-clickable">修改</span></nobr>');
                            if (html) {
                    ...
                    editor.addListener("selectionchange", function(t, causeByUi) {
                        ...
                        if (img && img.tagName == "IMG") {
                            ...
                            if (img.getAttribute("anchorname")) {
                                ...
                                html = popup.formatHtml('<nobr>属性: <span onclick=$$._onImgEditButtonClick("anchorDialog") class="edui-clickable">修改</span>&nbsp;&nbsp;' + "<span onclick=$$._onRemoveButtonClick('anchor') class=\"edui-clickable\">删除</span></nobr>");
                            }
                            ...
                            !html && (html = popup.formatHtml('<nobr>属性: <span onclick=$$._onImgSetFloat("none") class="edui-clickable">默认</span>&nbsp;&nbsp;' + '<span onclick=$$._onImgSetFloat("left") class="edui-clickable">居左</span>&nbsp;&nbsp;' + '<span onclick=$$._onImgSetFloat("right") class="edui-clickable">居右</span>&nbsp;&nbsp;' + '<span onclick=$$._onImgSetFloat("center") class="edui-clickable">居中</span>&nbsp;&nbsp;' + "<span onclick=\"$$._onImgEditButtonClick('" + dialogName + '\');" class="edui-clickable">修改</span></nobr>'));
                        }
                        if (editor.ui._dialogs.linkDialog) {
                            ...
                            if (link && (url = (link.getAttribute("data_ue_src") || link.getAttribute("href", 2)))) {
                                ...
                                html += popup.formatHtml('<nobr>链接: <a target="_blank" href="' + url + '" title="' + url + '" >' + txt + "</a>" + ' <span class="edui-clickable" onclick="$$._onEditButtonClick();">修改</span>' + ' <span class="edui-clickable" onclick="$$._onRemoveButtonClick(\'unlink\');"> 清除</span></nobr>');
